    ...
    <div className="container mx-auto p-4 space-y-6">
      ...
      <Alert className="border-green-200 bg-green-50">
        ...
        <AlertDescription className="text-green-700">
          <strong>Universal Admin Access:</strong> You have full access to all system data and features without authentication requirements.
        </AlertDescription>
      </Alert>
